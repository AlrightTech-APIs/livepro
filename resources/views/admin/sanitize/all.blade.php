    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col">
                        <h3 class="page-title">Files For Scrubbing</h3>
                    </div>
                    <div class="col-auto text-end">
                        <a href="{{ route('admin.add.sanitize') }}" class="btn btn-primary add-button ms-3">
                                        ...
                                        @foreach ($sanitizes as $sanitize)
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <form id="delete-dnc-form-{{ $sanitize->id }}" action="{{ route('admin.delete.sanitize',$sanitize->id) }}" method="POST" class="d-none">
                                                        @csrf
                                                        @method('delete')
                                                    </form>
                                                </td>
