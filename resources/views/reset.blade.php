            ...
            <div class="login-body container">
                <div class="loginbox" style="border: 5px solid #a67a3d;">
                    <div class="login-right-wrap">
                        <div class="account-header">
                            <div class="account-logo text-center mb-4">
                                <a href="{{ route('user.add.sanitize') }}">
                        ...
                        <form class="login-form" action="{{ route('user.password.update') }}" method="POST">
                            @csrf
                    ...
                    <div class="text-center">
                        <button class="btn btn-primary btn-block account-btn" type="submit">Update</button>
                    </div>
                    </form>
                </div>
            </div>
